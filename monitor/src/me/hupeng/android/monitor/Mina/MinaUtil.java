...
//            minaSimpleListener.onReceive(messageAndIosession.message,messageAndIosession.ioSession);
...
//            System.out.println("messageSent");
        ...
        public void sessionClosed(IoSession session) throws Exception {
            ...
            //连接关闭的时候进行调用
            if (minaSimpleListener != null){
                minaSimpleListener.closed();
            }
